  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-20 mb-8">
        ...
        <button
          onClick={Search}
          class="flex items-center px-8 text-white bg-green-800 -ml-2 focus:outline-none focus:ring-primary-300 transition ease-in-out font-medium rounded text-sm py-1 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
          <svg
                  ...
                  >
                    <div className="flex mb-1 transition ease-in-out delay-150">
                      ...
                      <div
                        ...
                        className="text-white w-10 h-10 2xl:w-14 2xl:h-14 border-[2px] 2xl:border-[3px] rounded-full p-2 mr-2 backdrop-blur-[1px] shadow-md ease-linear transition-all duration-150 hover:border-green-600 hover:text-green-600"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                    ...
                    <a class="hover:text-primary-600 text-shadow-xl shadow-green-700 text-white text-base 2xl:text-2xl transition duration-500 font-medium">
